...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView imgViewssplash;

  private ActivitySplashScreenBinding(@NonNull RelativeLayout rootView,
      @NonNull ImageView imgViewssplash) {
    this.rootView = rootView;
    this.imgViewssplash = imgViewssplash;
  }
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.imgViewssplash;
      ImageView imgViewssplash = ViewBindings.findChildViewById(rootView, id);
      if (imgViewssplash == null) {
        break missingId;
      }

      return new ActivitySplashScreenBinding((RelativeLayout) rootView, imgViewssplash);
    }
