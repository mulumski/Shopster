...
public final class ListItemBinding implements ViewBinding {
  ...
  private ListItemBinding(@NonNull RelativeLayout rootView, @NonNull ImageView itemImage,
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListItemBinding((RelativeLayout) rootView, itemImage, itemName, itemPrice);
    }
